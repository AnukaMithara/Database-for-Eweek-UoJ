...
<link rel="stylesheet" type="text/css" href="formstyle.css">          <!--Link to the css file-->
        ...
        <div id = "box">
            <form method = "post">
                ...
                <input placeholder="Player Registration number : 20**/E/***" type="text" class="input" required="" name = "reg_id"> <br><br>                <!╌ creating a text box for the user to enter their email. Getting inputs for email -->
