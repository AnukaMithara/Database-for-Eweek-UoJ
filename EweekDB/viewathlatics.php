...
<head>
    <title>View Registrants for Athlatic Activities</title>
</head>
    ...
    <div id="box">
        <form method="post">
            <div style="color: #111; font-family: 'Helvetica Neue', sans-serif; font-size: 40px; 
                font-weight: bold; letter-spacing: -1px; line-height: 1; text-align: center;">Details of Athlatic Activities</div>
                <br><br><br>
